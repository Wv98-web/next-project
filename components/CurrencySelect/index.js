...
export default function CurrencySelect() {
  return (
    <div className="fixed top-2 right-2 z-30 w-56 text-right">
          ...
          <Menu.Items className="absolute right-0 mt-2 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="px-1 py-1">
              <Menu.Item>
                <a
                  href="#"
                  className="flex w-full items-center rounded-md px-2 py-2 text-gray-700 hover:bg-violet-500 hover:text-white"
                >
                  <img
